...
export async function GET(
  ...
  try {
    ...
    // ดึงจำนวน chapter ของแต่ละ branch
    ...
    const branches = (sessions ?? []).map(
      (session) => ({
        ...
        userName:
          playerNames[session.user_id] ?? 'ผู้เล่น',
